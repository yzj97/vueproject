...
export default {
  data(){
    return {username:'bmw',password:'bmw123'}
  },
  methods: {
    checkLogin(){
      this.$store.dispatch({
...
<style  scoped>
 body{ background:#f2f4f5;}
    ...
    .content .fhbtn a{ display:block;width:0.23rem;height:0.25rem; background:url(../assets/Images/history1.png) no-repeat 0 0; background-size:100%; margin-left:0.3rem;}
    .content h1{width:2.18rem;height:1.35rem; background:url(../assets/Images/say.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
    ...
    .content ul li{height:0.95rem; position:relative;list-style: none}
